    ...
    public static class ConnectionSetting
    {
        internal static string CONNECTION_STRING
        {
            get
            {
                ...
                {
                    string _connectionString = string.Format("Data Source=192.168.0.130,1433; Initial Catalog=MVCPersonDB; User ID=sa; Password=newuser@123", SQLDB_SERVER, SQLDB_DATABASE,
